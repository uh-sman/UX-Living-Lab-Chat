...
const Buttons = () => {
  return (
    <div className="d-flex gap-4 overflow-x-scroll overflow-x-md-none overflow-x-md-none  overflow-x-xl-none  overflow-x-xxl-none">
      <button type="button" className="btn btn-lg-full button 2">
        Login
      </button>
