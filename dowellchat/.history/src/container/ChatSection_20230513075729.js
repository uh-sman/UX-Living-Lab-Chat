...
const ChatSection = () => {
  return (
    <div className="container">
      ...
      "
      >
        <div className="d-flex align-items-center myStyle flex-column flex-md-row flex-lg-row flex-xl-row flex-xxl-row mb-5 mb-md-5 mb-lg-2 mb-lg-2 mb-xl-2 mb-xxl-2">
          <SearchBar />
          <ProfileHead />
        </div>
      </div>
