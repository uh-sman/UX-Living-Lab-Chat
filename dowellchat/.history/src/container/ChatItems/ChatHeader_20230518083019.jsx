...
const ChatHeader = ({ title, caption, onSetChatHeader }) => {
  return (
    <div className="c">
      ...
      <div className=" d-flex flex-column flex-md-row flex-lg-row flex-xl-row flex-xxl-row my-3 justify-content-between">
        <header>
          <h1 className="header fs-5 fw-bold">{title}</h1>
