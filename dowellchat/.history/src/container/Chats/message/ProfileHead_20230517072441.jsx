...
const ProfileHead = ({ chatHeader }) => {
  ...
  const { rooms } = result;
  return (
    <div className="container overflow-y-auto  my-0 my-md-0 my-lg-0 my-xl-0 my-xxl-0">
      {/* <div className="d-flex align-items-center gap-5"> */}
      {/* <SearchBar /> */}
      <div className="w-full d-flex justify-content-between gap-3 align-items-center border-bottom my-0 my-md-0 my-lg-0 my-xl-0 my-xxl-0">
        <figure className="d-flex gap-3 align-items-center">
          ...
          <div className="">
            {/* Room number */}
            <h1 className="fs-5 fb-extrabold">{result?.rooms?.[0]?.room_id}</h1>
