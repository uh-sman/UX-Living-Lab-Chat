...
const ProfileHead = ({ chatHeader }) => {
  ...
  const { rooms } = result;
  return (
    <div className=" d-flex flex-column flex-md-row flex-lg-row flex-xl-row flex-xxl-row mb-5 mb-md-5 mb-lg-2 mb-lg-2 mb-xl-2 mb-xxl-2 ">
      <SearchBar results={result} />
      <div className="" style={{ gap: "4rem" }}>
        <div className=" d-flex  gap-3 align-items-center border-bottom my-0 my-md-0 my-lg-0 my-xl-0 my-xxl-0 justify-content-between">
