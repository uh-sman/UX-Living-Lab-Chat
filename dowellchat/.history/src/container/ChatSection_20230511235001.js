...
const ChatSection = () => {
  return (
    <div className="container">
      ...
      {/* chats come here */}
      <div className="container">
        <div className="d-flex gap-0 gap-md-0 gap-lg-4 gap-xl-4 gap-xxl-5 flex-column flex-md-column flex-lg-row flex-xl-row flex-xxl-row mb-5 mb-md-5 mb-lg-2 mb-lg-2 mb-xl-2 mb-xxl-2">
          <SearchBar />
          <ProfileHead />
        </div>
      </div>
